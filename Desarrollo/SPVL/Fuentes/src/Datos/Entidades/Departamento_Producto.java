 ...
 * @author richard
 */
public class Departamento_Producto {
    private int idDepartamentoProducto;
    private int idDepartamento;
    private int idProducto;
    
    
    public Departamento_Producto(){
        
    }
    public Departamento_Producto(int idDepartamento, int idProducto){
        
        this.idDepartamento = idDepartamento;
        this.idProducto = idProducto;
    }
    
    public Departamento_Producto(int idDepartamentoProducto, int idDepartamento, int idProducto){
