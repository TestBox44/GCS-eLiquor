...
public class PanelDeUsuarios extends javax.swing.JPanel implements PropertyChangeListener{
    ...
    public PanelDeUsuarios() {
        ...
        ((Buscador)buscador).getBtnBuscar().addMouseListener(new java.awt.event.MouseAdapter(){
            @Override
        ...
        ((Buscador)buscador).getTxtABuscar().addActionListener(new ActionListener(){
            @Override
    ...
    private void initComponents() {
        ...
        contenedorPrincipal = new PanelImagen("/Presentacion/Imagenes/Paneles/Usuarios/PanelUsuarios.png");
        TituloDeModulo = new javax.swing.JLabel();
        lblOrden = new javax.swing.JLabel();
        selectorOrden = new Selector(new String[]{"ALFABÉTICO","FECHA REGIS."},123,37);
        ...
        lblDia.setMaximumSize(new java.awt.Dimension(200, 16));
        lblDia.setPreferredSize(new java.awt.Dimension(310, 24));
        contenedorPrincipal.add(lblDia, new org.netbeans.lib.awtextra.AbsoluteConstraints(871, 26, -1, -1));
    ...
    private void btnHomeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHomeMousePressed
        JPanel parent = (JPanel)(getParent().getParent().getParent());
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        //System.out.println(((Selector)evt.getSource()).getNombreDeSelector());
