 ...
 * @author sortizu
 */
public class AgregarClientes extends VentanaEmergente{
    ...
    public AgregarClientes(PanelDeClientes panelPrincipalDeModuloDeClientes) {
        ...
        setTextoTitulo("AGREGAR CLIENTE");
