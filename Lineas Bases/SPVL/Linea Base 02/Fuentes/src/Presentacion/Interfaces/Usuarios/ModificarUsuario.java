 ...
 * @author sortizu
 */
public class ModificarUsuario extends PanelImagen{
    ...
    public ModificarUsuario(PanelDeUsuarios panelPrincipalDeModuloUsuarios, int indice) {
        super("/Presentacion/Imagenes/Paneles/Usuarios/PanelAgregarUsuarios.png");
        initComponents();
        //Cargando datos
        Usuario usuarioSeleccionado = panelPrincipalDeModuloUsuarios.usuarios.get(indice);
    ...
    private void initComponents() {
        ...
        lblAGREGARUSUARIOS1.setForeground(new java.awt.Color(95, 126, 205));
        lblAGREGARUSUARIOS1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblAGREGARUSUARIOS1.setText("MODIFICAR USUARIO");
    ...
    private void btnAceptarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAceptarMousePressed
        if(txtpassword.getPassword().length==4){
            if(txtNombre.getText().isBlank()){
                ...
                Usuario usuario=panelPrincipalDeModuloUsuarios.usuarios.get(indice);
                usuario.setNombre(txtNombre.getText());
                usuario.setGestionarVentas(selectorVentas.getValorDeSelector());   
                usuario.setGestionarUsuarios(selectorUsuarios.getValorDeSelector());   
                usuario.setGestionarProveedores(selectorProveedores.getValorDeSelector());   
                usuario.setGestionarClientes(selectorClientes.getValorDeSelector());   
                usuario.setGestionarInventario(selectorInventario.getValorDeSelector());   
                usuario.setGenerarReportes(selectorReportes.getValorDeSelector());
                panelPrincipalDeModuloUsuarios.modificarUsuarioDeLaTabla(indice, usuario);
                ControlUsuarios.modificarUsuario(indice,usuario, new String(txtpassword.getPassword()));
                ((FramePrincipal)((JFrame) SwingUtilities.getWindowAncestor(this))).cerrarPanelesEmergentes();
            }
        }else{
